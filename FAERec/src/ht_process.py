...
def classify_head_and_tail(user_seq: List[List[int]],
    ...
    max_item_interaction = item_cnt[sorted_items[0]] if sorted_items else 0  
    ...
    return avg_len,item_cnt, max_item_interaction

def count_item_popularity(user_seq):
    # For popularity grouping, remove the last two items to prevent data leakage.
