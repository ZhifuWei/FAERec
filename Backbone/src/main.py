...
from ht_process import classify_head_and_tail
...
def main():
    ...
    parser.add_argument("--star_test", default=200, type=int)
    ...
    #Partitioning the head and tail item sets
    args.average_len,args.user_cnt,args.item_cnt = classify_head_and_tail(
                        user_seq,
                        args.head_ratio,
                        args.head_items,
                        args.tail_items,
